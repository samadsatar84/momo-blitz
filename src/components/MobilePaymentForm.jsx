...
export default function MobilePaymentForm({ total, cart, customerInfo, onSuccess, paymentMethod }) {
  ...
  const handlePayment = async (e) => {
    ...
    // For COD, transaction ID is optional
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 rounded-lg p-4 border-2 border-blue-300">
                ...
                <div className="space-y-2 text-gray-700 text-sm mb-3">
                  ...
                  <div className="flex justify-between">
                    <span>Delivery:</span>
                    <span className="text-orange-600 font-bold">Rs. {DELIVERY_CHARGES}</span>
                  </div>
                </div>
                <p className="text-3xl md:text-4xl font-black text-blue-600">Rs. {finalTotal}</p>
              </div>
